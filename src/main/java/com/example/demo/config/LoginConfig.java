...
public class LoginConfig extends UsernamePasswordAuthenticationFilter {

    private final ObjectMapper objectMapper;

    LoginConfig(final AuthenticationManager authenticationManager, final ObjectMapper objectMapper) {
    ...
    protected void successfulAuthentication(final HttpServletRequest request, final HttpServletResponse response,
        ...
        final CustomEntity authenticatedUser = (CustomEntity) auth.getPrincipal();
